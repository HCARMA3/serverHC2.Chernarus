...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%1'>%3</t> is on the way to support nearby paramilitary outposts.<br/> Rumors say, they also transporting soldiers' earnings for this week: <t color='%1'>%2</t>! <br/>Stop this convoy and let their families eat shit this month!", moneyMissionColor, _moneyText, _vehicleName];
