...
_setupObjects =
{
	...
	_obj1 = createVehicle ["B_Truck_01_mover_F", _bargate modelToWorld [6.5,-2,-4.1], [], 0, "NONE"];
	_obj2 = createVehicle ["Land_Cargo20_grey_F", _bargate modelToWorld [-8,-2,-4.1], [], 0, "NONE"];
	...
	_missionHintText = format ["<br/>A Truck has derailed!<br/>Go there, kill the guards and save the cargo!", specialMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["<br/>The cargo of the Truck has been saved. Good work!"];
};
