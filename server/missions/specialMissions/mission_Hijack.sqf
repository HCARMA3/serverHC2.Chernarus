...
_setupObjects =
{
    _missionLocation = ["Race_3","Race_4"] call bis_fnc_selectRandom;
    _dropLoc1 = ["dropOff_3","dropOff_4"] call bis_fnc_selectRandom;
    ...
    _missionHintText = format ["Hijack the vehicle and deliver to one of the possible destination markers.", specialMissionColor];
};
