...
_setupObjects =
{
	...
	_missionHintText = format ["Be aware! A <t color='%2'>%1</t> has been spotted, transporting lots of drugs! Stop this, <t color='%2'>before</t> it arrives final destination", _vehicleName, sideMissionColor];
