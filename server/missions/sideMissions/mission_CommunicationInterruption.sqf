...
_setupObjects =
{
	...
	_camonet = createVehicle ["Land_Communication_F", [_missionPos select 0, _missionPos select 1], [], 0, "CAN COLLIDE"];
	...
	_missionHintText = format ["<br/>Paramilitary units occupied a <t color='%1'>radio tower</t> to hack the communication on Tanoa.<br/>Go there, kill these stupid shitheads and clear the area!", sideMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [1500,1750,21000,21250,31500];
