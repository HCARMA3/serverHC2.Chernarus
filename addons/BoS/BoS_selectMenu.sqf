...
#define ITEM_CONDITION "{cursortarget iskindof 'Land_AirConditioner_01_F'} && {alive cursorTarget} && {(player distance cursortarget) < 5}"
...
BoS_open = 
{
	...
	_objects = nearestObjects [player, ["Land_AirConditioner_01_F"], 5];
