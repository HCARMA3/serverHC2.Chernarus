...
switch (WorldName) do
{
    ...
    case "Chernarus": { BRAma_upperLimit = 15460; };
    ...
    while {true} do
    {
		...
		{    
			if (BRAma_isInDebugZone) then 
			{
				...
				[
					[
						[BRAma_DebugZoneKillMessage1,"<t align = 'center' shadow = '1' size = '0.8' font='PuristaMedium'>%1</t><br/>"],
						[BRAma_DebugZoneKillMessage2,"<t align = 'center' shadow = '1' size = '0.8' font='PuristaMedium'>%1</t><br/>",100]
					]
			...
			else
			{
				...
				[
					[
						[BRAma_DebugZoneMessage1,"<t align = 'left' shadow = '1' size = '0.8' font='PuristaMedium'>%1</t><br/><br/>"],
						[BRAma_DebugZoneMessage2,"<t align = 'left' shadow = '1' size = '0.6' font='PuristaMedium'>%1</t><br/><br/>"],
						[BRAma_DebugZoneMessage3,"<t align = 'left' shadow = '1' size = '0.6' font='PuristaMedium'>%1</t><br/>"]
					]
				] spawn BIS_fnc_typeText;
				...
				[
					[
						[BRAma_DebugZoneFinalMessage1,"<t align = 'left' shadow = '1' size = '0.8' font='PuristaMedium'>%1</t><br/><br/>"],
						[BRAma_DebugZoneFinalMessage2,"<t align = 'left' shadow = '1' size = '0.6' font='PuristaMedium'>%1</t><br/><br/>"]
					]
				] spawn BIS_fnc_typeText;
