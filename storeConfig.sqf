...
[
	...
	["MX Carbine (Khaki)", "arifle_MXC_khk_F", 350, "noDLC"],
	["MX Rifle", "arifle_MX_F", 350],
	["MX Rifle (Black)", "arifle_MX_Black_F", 350],
	["MX Rifle (Khaki)", "arifle_MX_khk_F", 350, "noDLC"],
	...
	["SPAR-16 GL Rifle", "arifle_SPAR_01_GL_blk_F", 450],
	["SPAR-16 GL Rifle (Khaki)", "arifle_SPAR_01_GL_khk_F", 450],
	["SPAR-16 GL Rifle (Sand)", "arifle_SPAR_01_GL_snd_F", 450],

	["CAR-95 Rifle", "arifle_CTAR_blk_F", 300],			
	["CAR-95 GL Rifle", "arifle_CTAR_GL_blk_F", 350],
	["Type 115 Rifle", "arifle_ARX_blk_F", 600],
	["Type 115 Rifle (Hex)", "arifle_ARX_hex_F", 600],
	["Type 115 Rifle (G Hex)", "arifle_ARX_ghex_F", 600],

	["AKS-74U Carbine", "arifle_AKS_F", 450],
	["AKM Rifle", "arifle_AKM_F", 700],
	["AK-12 Rifle", "arifle_AK12_F", 1000],
	["AK-12 GL Rifle", "arifle_AK12_GL_F", 1250],

	// Marksman Rifles
	["MXM Rifle", "arifle_MXM_F", 500],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 500],
	["MXM Rifle (Khaki)", "arifle_MXM_khk_F", 500, "noDLC"],
	["Rahim DMR Rifle", "srifle_DMR_01_F", 775],
	["Mk18 ABR Rifle", "srifle_EBR_F", 775],

	// DLC
	["CMR-76 Rifle", "srifle_DMR_07_blk_F", 600],
	["CMR-76 Rifle (Hex)", "srifle_DMR_07_hex_F", 600],
	["CMR-76 Rifle (G Hex)", "srifle_DMR_07_ghex_F", 600],
	...
	["Mk14 Rifle (Camo)", "srifle_DMR_06_camo_F", 1000],
	["Mk14 Rifle (Olive)", "srifle_DMR_06_olive_F", 1000],
	["Mk-I EMR Rifle", "srifle_DMR_03_F", 1000],
	["Mk-I EMR Rifle (Camo)", "srifle_DMR_03_multicam_F", 1000],
	["Mk-I EMR Rifle (Khaki)", "srifle_DMR_03_khaki_F", 1000],
	["Mk-I EMR Rifle (Sand)", "srifle_DMR_03_tan_F", 1000],
	["Mk-I EMR Rifle (Woodland)", "srifle_DMR_03_woodland_F", 1000],
	["MAR-10 Rifle", "srifle_DMR_02_F", 1750],
	["MAR-10 Rifle (Camo)", "srifle_DMR_02_camo_F", 1750],
	["MAR-10 Rifle (Sand)", "srifle_DMR_02_sniper_F", 1750],
	["Cyrus Rifle", "srifle_DMR_05_blk_F", 1750],
	["Cyrus Rifle (Hex)", "srifle_DMR_05_hex_F", 1750],
	["Cyrus Rifle (Tan)", "srifle_DMR_05_tan_f", 1750],

	// Sniper Rifles
	["M320 LRR Sniper", "srifle_LRR_LRPS_F", 2000],
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_LRPS_F", 2200],
	["M320 LRR Sniper (Tropic)", "srifle_LRR_tna_LRPS_F", 2200],
	["GM6 Lynx Sniper", "srifle_GM6_LRPS_F", 4000],
	["GM6 Lynx Sniper (Camo)", "srifle_GM6_camo_LRPS_F", 4000],
	["GM6 Lynx Sniper (G Hex)", "srifle_GM6_ghex_LRPS_F", 4000],

	["ASP-1 Kir Rifle", "srifle_DMR_04_F", 3500],
	["ASP-1 Kir Rifle (Tan)", "srifle_DMR_04_tan_F", 3500]
];

lmgArray = compileFinal str
[
	["MX SW LMG", "arifle_MX_SW_F", 1000],
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 1000],
	["MX SW LMG (Khaki)", "arifle_MX_SW_khk_F", 1000, "noDLC"],
	["Mk200 LMG", "LMG_Mk200_F", 1000],
	["Zafir LMG", "LMG_Zafir_F", 1100],
	...
	["CAR-95-1 LMG", "arifle_CTARS_blk_F", 950],
...
[
	...
	["RPG-42 Alamut", "launch_RPG32_F", 650],
	["RPG-42 Alamut (G Hex)", "launch_RPG32_ghex_F", 650, "noDLC"],
	...
	["Titan MPRL AA (Sand)", "launch_Titan_F", 3600],
	["Titan MPRL AA (Hex)", "launch_O_Titan_F", 3600],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 3600],
	["Titan MPRL AA (Tropic)", "launch_B_Titan_tna_F", 3600, "noDLC"],
	["Titan MPRL AA (G Hex)", "launch_O_Titan_ghex_F", 3600, "noDLC"]
];
...
[
	...
	["Mk6 Mortar", "B_Mortar_01_F", 32500],
	["Mk6 Mortar", "O_Mortar_01_F", 32500],
	["Mk6 Mortar", "I_Mortar_01_F", 32500]
];
...
[
	...
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 450],
...
[
	...
	["TWS", "optic_tws", 45000, "item"], // To hide from store list, add "HIDDEN" after "item", like "item", "HIDDEN"]
	["TWS MG", "optic_tws_mg", 46000, "item"],
	["Nightstalker", "optic_Nightstalker", 57500, "item"]
];
...
[
	...
	["Light Ghillie (Jungle)", "U_B_T_Sniper_F", 1000, "uni"],
	["Light Ghillie (Jungle)", "U_O_T_Sniper_F", 1000, "uni"],
...
[
	["Rebreather (NATO)", "V_RebreatherB", 200, "vest", "HIDDEN"],
	["Rebreather (CSAT)", "V_RebreatherIR", 200, "vest", "HIDDEN"],
	["Rebreather (AAF)", "V_RebreatherIA", 200, "vest", "HIDDEN"],
	["Carrier Lite (Green)", "V_PlateCarrier1_rgr", 300, "vest"],
	["Carrier Lite (Black)", "V_PlateCarrier1_blk", 300, "vest"],
	["Carrier Lite (CTRG)", "V_PlateCarrierL_CTRG", 300, "vest"],
	["Carrier Lite (Tropic)", "V_PlateCarrier1_tna_F", 300, "vest", "noDLC"],
	["Carrier Rig (Green)", "V_PlateCarrier3_rgr", 350, "vest"],
	["Carrier Rig (Black)", "V_PlateCarrier2_blk", 350, "vest"],
	["Carrier Rig (CTRG)", "V_PlateCarrierH_CTRG", 350, "vest"],
	["Carrier Rig (Tropic)", "V_PlateCarrier2_tna_F", 350, "vest", "noDLC"],
	["Carrier GL Rig (Green)", "V_PlateCarrierGL_rgr", 350, "vest"],
	["Carrier GL Rig (Black)", "V_PlateCarrierGL_blk", 350, "vest"],
	["Carrier GL Rig (MTP)", "V_PlateCarrierGL_mtp", 350, "vest"],
	["Carrier GL Rig (Tropic)", "V_PlateCarrierGL_tna_F", 350, "vest", "noDLC"],
	["Carrier Special Rig (Green)", "V_PlateCarrierSpec_rgr", 350, "vest"],
	["Carrier Special Rig (Black)", "V_PlateCarrierSpec_blk", 350, "vest"],
	["Carrier Special Rig (MTP)", "V_PlateCarrierSpec_mtp", 350, "vest"],
	["Carrier Special Rig (Tropic)", "V_PlateCarrierSpec_tna_F", 350, "vest", "noDLC"],
	...
	["LBV Harness", "V_HarnessO_brn", 150, "vest"],
	["LBV Harness (Gray)", "V_HarnessO_gry", 150, "vest"],
	["LBV Grenadier Harness", "V_HarnessOGL_brn", 150, "vest"],
	["LBV Grenadier Harness (Gray)", "V_HarnessOGL_gry", 150, "vest"],
	["ELBV Harness", "V_HarnessOSpec_brn", 200, "vest"],
	["ELBV Harness (Gray)", "V_HarnessOSpec_gry", 200, "vest"],													 														
	...
	["Tactical Vest (Stavrou)", "V_I_G_resistanceLeader_F", 200, "vest"],
	["CTRG Plate Carrier Rig Mk.1 (Light)", "V_PlateCarrierL_CTRG", 250, "vest"],
	["CTRG Plate Carrier Rig Mk.2 (Heavy)", "V_PlateCarrierH_CTRG", 350, "vest"],																		  																	  
	["Press Vest", "V_Press_F", -1, "vest", "Hidden"]
];
...
[
	...
	["Assault Pack (Black)", "B_AssaultPack_blk", 200, "backpack"],
	["Assault Pack (Green)", "B_AssaultPack_rgr", 200, "backpack"],
	["Assault Pack (MTP)", "B_AssaultPack_mcamo", 200, "backpack"],
	["Assault Pack (Hex)", "B_AssaultPack_ocamo", 200, "backpack"],
	["Assault Pack (Tropic)", "B_AssaultPack_tna_F", 200, "backpack", "noDLC"],
	...
	["Bergen (Digital)", "B_Bergen_dgtl_F", 450, "backpack", "noDLC"],
	["Bergen (Hex)", "B_Bergen_hex_F", 450, "backpack", "noDLC"],
	["Bergen (MTP)", "B_Bergen_mcamo_F", 450, "backpack", "noDLC"],
	["Bergen (Tropic)", "B_Bergen_tna_F", 450, "backpack", "noDLC"]
];
...
[
	...
	["UAV Terminal (NATO)", "B_UavTerminal", 450, "gps"],
	["UAV Terminal (CSAT)", "O_UavTerminal", 450, "gps"],
	["UAV Terminal (AAF)", "I_UavTerminal", 450, "gps"],
	...
	["Laser Designator (Sand)", "Laserdesignator", 1250, "binoc", "noDLC"], // Increase price to 2500 if A3W_disableBuiltInThermal = 0
	["Laser Designator (Hex)", "Laserdesignator_02", 1300, "binoc", "noDLC"],
	["Laser Designator (Olive)", "Laserdesignator_03", 1250, "binoc", "noDLC"],
...
[
	...
	["Kart", "C_Kart_01_F", 150, "vehicle", "SKIPSAVE"],
	["Quadbike (Civilian)", "C_Quadbike_01_F", 150, "vehicle", "SKIPSAVE"],
	["Quadbike (NATO)", "B_Quadbike_01_F", 150, "vehicle", "SKIPSAVE"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 150, "vehicle", "SKIPSAVE"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 150, "vehicle", "SKIPSAVE"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 150, "vehicle", "SKIPSAVE"],
	["Hatchback", "C_Hatchback_01_F", 300, "vehicle", "SKIPSAVE"],
	["Hatchback Sport", "C_Hatchback_01_sport_F", 200, "vehicle", "SKIPSAVE"],
	["SUV", "C_SUV_01_F", 400, "vehicle", "SKIPSAVE"],

	["MB 4WD", "C_Offroad_02_unarmed_F", 200, "vehicle", "SKIPSAVE"],
	["MB 4WD (Guerilla)", "I_C_Offroad_02_unarmed_F", 400, "vehicle", "SKIPSAVE"],

	["Offroad", "C_Offroad_01_F", 200, "vehicle", "SKIPSAVE"],
	["Offroad Camo", "B_G_Offroad_01_F", 250, "vehicle", "SKIPSAVE"],
	["Offroad Repair", "C_Offroad_01_repair_F", 500, "vehicle", "SKIPSAVE"],
	["Offroad HMG", "B_G_Offroad_01_armed_F", 500, "vehicle", "SKIPSAVE"],

	["Truck", "C_Van_01_transport_F", 500, "vehicle", "SKIPSAVE"],
	["Truck (Camo)", "B_G_Van_01_transport_F", 500, "vehicle", "SKIPSAVE"],
	["Truck Box", "C_Van_01_box_F", 500, "vehicle", "SKIPSAVE"],
	["Fuel Truck", "C_Van_01_fuel_F", 500, "vehicle", "SKIPSAVE"],
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 500, "vehicle", "SKIPSAVE"],

	["HEMTT Tractor", "B_Truck_01_mover_F", 500, "vehicle"],
	["HEMTT Resupply", "B_Truck_01_ammo_F", 4000, "vehicle"],
	...
	["HEMTT Fuel", "B_Truck_01_fuel_F", 500, "vehicle"],
	["HEMTT Medical", "B_Truck_01_medical_F", 500, "vehicle"],
	["HEMTT Repair", "B_Truck_01_Repair_F", 2000, "vehicle"],

	["Tempest Device", "O_Truck_03_device_F", 500, "vehicle"],
	["Tempest Resupply", "O_Truck_03_ammo_F", 4000, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 500, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 500, "vehicle"],
	["Tempest Fuel", "O_Truck_03_fuel_F", 500, "vehicle"],
	["Tempest Medical", "O_Truck_03_medical_F", 500, "vehicle"],
	["Tempest Repair", "O_Truck_03_repair_F", 2000, "vehicle"],

	["Zamak Resupply", "I_Truck_02_ammo_F", 1000, "vehicle"],
	["Zamak Transport", "I_Truck_02_transport_F", 4000, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 500, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 600, "vehicle"],
	["Zamak Medical", "I_Truck_02_medical_F", 700, "vehicle"],
	["Zamak Repair", "I_Truck_02_box_F", 2000, "vehicle"],

	["UGV Stomper (NATO)", "B_UGV_01_F", 5500, "vehicle"],
	["UGV Stomper RCWS (NATO)", "B_UGV_01_rcws_F", 35000, "vehicle"],
	["UGV Stomper (AAF)", "I_UGV_01_F", 5500, "vehicle"],
	["UGV Stomper RCWS (AAF)", "I_UGV_01_rcws_F", 35000, "vehicle"],
	["UGV Saif (CSAT)", "O_UGV_01_F", 5500, "vehicle"],
	["UGV Saif RCWS (CSAT)", "O_UGV_01_rcws_F", 35000, "vehicle"]
];

armoredArray = compileFinal str
[
	["Prowler (Doorless)", "B_CTRG_LSV_01_light_F", 500, "vehicle", "SKIPSAVE"],
	["Prowler", "B_T_LSV_01_unarmed_F", 500, "vehicle", "SKIPSAVE"],
	["Prowler HMG", "B_T_LSV_01_armed_F", 4000, "vehicle", "SKIPSAVE"],
	["Qilin", "O_T_LSV_02_unarmed_F", 500, "vehicle", "SKIPSAVE"],
	["Qilin Minigun", "O_T_LSV_02_armed_F", 4000, "vehicle", "SKIPSAVE"],

	["Hunter", "B_MRAP_01_F", 500, "vehicle", "SKIPSAVE"],
	...
	["Strider", "I_MRAP_03_F", 500, "vehicle", "SKIPSAVE"],
	["Strider HMG", "I_MRAP_03_hmg_F", 5000, "vehicle"],
	["Strider GMG", "I_MRAP_03_gmg_F", 7500, "vehicle"],
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 10500, "vehicle"],
	["AMV-7 Marshall", "B_APC_Wheeled_01_cannon_F", 14500, "vehicle"],
	["AFV-4 Gorgon", "I_APC_Wheeled_03_cannon_F", 15000, "vehicle"]
];

tanksArray = compileFinal str
[
	["CRV-6e Bobcat (Resupply)", "B_APC_Tracked_01_CRV_F", 14500, "vehicle"],
	...
	["ZSU-39 Tigris AA", "O_APC_Tracked_02_AA_F", 25000, "vehicle"],
	["M2A1 Slammer", "B_MBT_01_cannon_F", 25000, "vehicle"],
	["M2A4 Slammer HMG", "B_MBT_01_TUSK_F", 27500, "vehicle"], // Commander gun variant
...
[
	...
	["PO-30 Orca (Black)", "O_Heli_Light_02_unarmed_F", 1000, "vehicle"], // Ka-60
	["WY-55 Hellcat (Green)", "I_Heli_light_03_unarmed_F", 2000, "vehicle"], // AW159
	["CH-49 Mohawk", "I_Heli_Transport_02_F", 1000, "vehicle"], // AW101

	["Mi-290 Taru (Resupply)", "O_Heli_Transport_04_ammo_F", 8000, "vehicle"],
	["Mi-290 Taru (Crane)", "O_Heli_Transport_04_F", 1000, "vehicle"], // CH-54
	["Mi-290 Taru (Box)", "O_Heli_Transport_04_box_F", 1000, "vehicle"],
	["Mi-290 Taru (Fuel)", "O_Heli_Transport_04_fuel_F", 1000, "vehicle"],
	["Mi-290 Taru (Bench)", "O_Heli_Transport_04_bench_F", 1000, "vehicle"],
	["Mi-290 Taru (Transport)", "O_Heli_Transport_04_covered_F", 1000, "vehicle"],
	["Mi-290 Taru (Medical)", "O_Heli_Transport_04_medevac_F",1000, "vehicle"],
	["Mi-290 Taru (Repair)", "O_Heli_Transport_04_repair_F", 8000, "vehicle"],

	["CH-67 Huron (Black)", "B_Heli_Transport_03_unarmed_F", 1000, "vehicle"], // CH-47
	["CH-67 Huron (Armed)", "B_Heli_Transport_03_F", 6000, "vehicle"], // CH-47 with 2 side miniguns

	["UH-80 Ghost Hawk", "B_Heli_Transport_01_F", 6000, "vehicle"], // UH-60 Stealth with 2 side miniguns
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 15000, "vehicle"], // Armed AH-6
	...
	["Mi-48 Kajman", "O_Heli_Attack_02_F", 45000, "vehicle"], // Mi-28 with gunner

	["MQ-12 Falcon UAV", "B_T_UAV_03_F", 60000, "vehicle"]
];
...
[
	...
	["KH-3A Fenghuang UAV", "O_T_UAV_04_CAS_F", 60000, "vehicle"]
];
